...
use alexdemers\OneSpanSign\Models\Validation;

/**
 * Class FieldTransformer
 * @package TagMyDoc\OneSpan\Models\Transformers
 */
class FieldTransformer implements Transformer
{
	/**
	...
	{
		$classBindings->register(new FieldBinding('validation', 'validation', Validation::class));
	}
